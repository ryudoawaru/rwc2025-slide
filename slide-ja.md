...
<!--
Speaker Note:
日本語(にほんご)と台湾語(たいわんご)のシステムは似(に)ています。

日本語(にほんご)では、一組(ひとくみ)の漢字(かんじ)が
一組(ひとくみ)の平仮名(ひらがな)に対応(たいおう)します。

画面(がめん)の例(れい)を見(み)てください。
「生活(せいかつ)」という漢字(かんじ)が「せいかつ」という平仮名(ひらがな)に対応(たいおう)します。

台湾語(たいわんご)も同(おな)じです。
一組(ひとくみ)の漢字(かんじ)が一組(ひとくみ)の POJ に対応(たいおう)します。

画面(がめん)の右側(みぎがわ)の例(れい)では、
最初(さいしょ)の二文字(にもじ)が最初(さいしょ)の POJ 単語(たんご)に対応(たいおう)します。

この共通点(きょうつうてん)があるため、
分詞(ぶんし)アライメント処理(しょり)が必要(ひつよう)になります。

一組(ひとくみ)の漢字(かんじ)と一組(ひとくみ)の音標(おんぴょう)を
正確(せいかく)に対応(たいおう)させる必要(ひつよう)があります。
-->
...
<!--
Speaker Note:
Phase 1 では、漢字(かんじ)と POJ 両方(りょうほう)のテキストを正規化(せいきか)します。

左側(ひだりがわ)は漢字側(かんじがわ)の処理(しょり)です。
KANJI_GSUB_PATTERNS で記号(きごう)の前後(ぜんご)にスペースを挿入(そうにゅう)します。

右側(みぎがわ)は POJ 側(がわ)の処理(しょり)です。
ROMAN_GSUB_PATTERNS で 65 個以上(こいじょう)のパターンを適用(てきよう)します。

重要(じゅうよう)なのは、POJ 側(がわ)でハイフンを保持(ほじ)することです。
ハイフンは音節(おんせつ)の区切(くぎ)りを示(しめ)すので、後(あと)の処理(しょり)で必要(ひつよう)です。
-->
...
<!--
Speaker Note:
1つ目(め)は語料検索(ごりょうけんさく)です。

今日説明(きょうせつめい)した分詞(ぶんし)アライメント処理(しょり)が活用(かつよう)されています。
漢字(かんじ)と台羅(たいら)が正確(せいかく)に一対一対応(いちたいいちたいおう)しています。

音声(おんせい)ファイルの再生(さいせい)、前後文脈(ぜんごぶんみゃく)の表示(ひょうじ)、高度(こうど)な検索(けんさく)フィルタ。
台湾語(たいわんご)の学習者(がくしゅうしゃ)が実際(じっさい)の使用例(しようれい)を豊富(ほうふ)に参照(さんしょう)できます。-->
...
<!--
Speaker Note:
2つ目(め)は教科書語彙(きょうかしょごい)の検索(けんさく)です。

台湾(たいわん)の小中学校(しょうちゅうがっこう)の教科書(きょうかしょ)で使(つか)われる語彙(ごい)をデータベース化(か)しました。
教科書別(きょうかしょべつ)、学年別(がくねんべつ)に分類(ぶんるい)され、漢字(かんじ)、台羅(たいら)、華語訳(かごやく)が併記(へいき)されています。

教育現場(きょういくげんば)での実用性(じつようせい)を重視(じゅうし)した設計(せっけい)です。-->
...
<!--
Speaker Note:
3つ目(め)は語法点検索(ごほうてんけんさく)です。

台湾語(たいわんご)の文法(ぶんぽう)パターンを体系的(たいけいてき)にまとめたデータベースです。
例文(れいぶん)は漢字(かんじ)、台羅(たいら)、華語訳(かごやく)が並(なら)んで表示(ひょうじ)されます。

これら3つの機能(きのう)の基盤(きばん)となっているのが、
今日紹介(きょうしょうかい)した分詞(ぶんし)アライメント処理技術(しょりぎじゅつ)です。-->
